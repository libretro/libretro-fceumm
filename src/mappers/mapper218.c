...
void Mapper218_Init(CartInfo *info) {
	...
	VPageR[0] = &NTARAM[mapping[mirror2bits][0]];
	VPageR[1] = &NTARAM[mapping[mirror2bits][1]];
	VPageR[2] = &NTARAM[mapping[mirror2bits][2]];
	VPageR[3] = &NTARAM[mapping[mirror2bits][3]];
	VPageR[4] = &NTARAM[mapping[mirror2bits][4]];
	VPageR[5] = &NTARAM[mapping[mirror2bits][5]];
	VPageR[6] = &NTARAM[mapping[mirror2bits][6]];
	VPageR[7] = &NTARAM[mapping[mirror2bits][7]];
	PPUCHRRAM = 0xFF;
}
