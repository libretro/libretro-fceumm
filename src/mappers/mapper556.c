...
static void M556PW_MMC3(uint32 A, uint8 V) {
...
static void M556CW_MMC3(uint32 A, uint8 V) {
...
static void M556PW_VRC4(uint32 A, uint8 V) {
	uint32 mask = M556PRGMask();
	uint32 base = M556PRGBase();
...
static void M556CW_VRC4(uint32 A, uint32 V) {
	uint32 mask = M556CHRMask();
	uint32 base = M556CHRBase();
...
void Mapper556_Init(CartInfo *info) {
	...
	VRC24_pwrap = M556PW_VRC4;
	VRC24_cwrap = M556CW_VRC4;

	MMC3_Init(info, 0, 0);
	MMC3_pwrap = M556PW_MMC3;
	MMC3_cwrap = M556CW_MMC3;
