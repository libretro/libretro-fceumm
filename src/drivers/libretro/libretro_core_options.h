...
struct retro_core_option_v2_definition option_defs[] = {
   ...
   },
   {
      ...
      "Invert Hardware Light Gun Trigger",
      NULL,
      "This can improve light gun responsiveness by firing on trigger press rather than on trigger release.",
      NULL,
      "input",
      {
         { "enabled",  NULL },
   ...
   },
   {
      ...
      "Invert Hardware Light Gun Sensor",
      NULL,
      "Commonly used for light guns that report light detection as logical HIGH state. Original NES hardware reports logical LOW for detection.",
      NULL,
      "input",
      {
         { "enabled",  NULL },
