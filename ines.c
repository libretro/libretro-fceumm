...
/*    INES_BOARD( "K-3088",                    287, BMCK3088_Init ) */
	...
	INES_BOARD( "BS-400",			422, Mapper422_Init         ) // Base mapper, BS-300/BS-400/BS-4040
	INES_BOARD( "PowerJoy 84-in-1 PJ-008",	126, Mapper126_Init         ) // Power Joy variant with swapped CHR A18/A19
	INES_BOARD( "NJ064",			534, Mapper534_Init         ) // Inverted $C000 register
INES_BOARD_END()
